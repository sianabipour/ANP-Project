    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_en', tinymce.models.HTMLField(verbose_name='content_en')),
                ('content_fa', tinymce.models.HTMLField(verbose_name='content_fa')),
                ('image_en', models.ImageField(upload_to='Product', verbose_name='image_en')),
                ('image_fa', models.ImageField(upload_to='Product', verbose_name='image_fa')),
                ...
                ('tags', models.ManyToManyField(to='shop.Tag', verbose_name='tags')),
            ],
            options={
